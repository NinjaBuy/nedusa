  ...
  return (
    <Switch
      ...
      className={clsx(
        ...
        "[&_span]:bg-ninja-fg-on-color [&_span]:shadow-details-switch-handle [&_span]:group-disabled:bg-ui-fg-disabled [&_span]:pointer-events-none",
